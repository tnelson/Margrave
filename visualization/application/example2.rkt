...
(define myquery
  "EXPLORE 
(inboundacl_fw2:Accept(interf, ipsrc, ipdest, portsrc, portdest, pro, tempnatip) AND
inboundnat_fw2:Translate(interf, ipsrc, ipdest, portsrc, portdest, pro, tempnatip)) AND

  ((inboundacl_fw1:Deny(interminterface, tempnatsrc, ipdest, portsrc, portdest, pro, tempnatsrc) AND
...
inboundacl_fw1:Deny(interminterface, tempnatsrc, ipdest, portsrc, portdest, pro, tempnatsrc),
