...
(define tasvector "(ahostname, entry-interface, 
...
(define bazvector "(ahostname, entry-interface, 
...
(define (run-queries-for-forum-2)
  ...
  (load-ios-policies (build-path (current-directory) "tasconfig") "tas" "1")
  (load-ios-policies (build-path (current-directory) "tasconfig-revised") "tas" "2")
  (load-ios-policies (build-path (current-directory) "bazconfig") "baz" "1")
;  (load-ios-policies (build-path (current-directory) "bazconfig-revised") "baz" "2")
