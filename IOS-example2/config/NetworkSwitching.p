(Policy
 ...
 (Target)
 (Rules
  (network-switch-Serial0/3/0:0-g934
   =
   (Forward
    hostname
    entry-interface
  ...
  (network-switch-GigabitEthernet0/0-g935
   =
   (Forward
    hostname
    entry-interface
  ...
  (network-switch-GigabitEthernet0/1-g936
   =
   (Forward
    hostname
    entry-interface
  ...
  (network-switch-drop-GigabitEthernet0/0-g937
   =
   (Forward
    hostname
    entry-interface
