...
(Theory pa-state
        ...
        (Axioms
         ...
         (formula (and
                   (not (before 'state0 'state0))
                   (before 'state0 'state1)
                   (before 'state0 'state2)
                   (before 'state0 'state3)
                   (before 'state0 'state4)
                   (before 'state0 'end)                       
                   (not (before 'state1 'state0))
                   (not (before 'state1 'state1))
                   (before 'state1 'state2)
                   (before 'state1 'state3)
                   (before 'state1 'state4)
                   (before 'state1 'end)                   
                   (not (before 'state2 'state0))
                   (not (before 'state2 'state1))
                   (not (before 'state2 'state2))                   
                   (before 'state2 'state3)
                   (before 'state2 'state4)
                   (before 'state2 'end)                                              
                   (not (before 'state3 'state0))
                   (not (before 'state3 'state1))
                   (not (before 'state3 'state2))
                   (not (before 'state3 'state3))
                   (before 'state3 'state4)
                   (before 'state3 'end)                   
                   (not (before 'state4 'state0))
                   (not (before 'state4 'state1))
                   (not (before 'state4 'state2))
                   (not (before 'state4 'state3))
                   (not (before 'state4 'state4))                                      
                   (before 'state4 'end)                   
                   (not (before 'end 'state0))
                   (not (before 'end 'state1))
                   (not (before 'end 'state2))
                   (not (before 'end 'state3))
                   (not (before 'end 'state4))                                      
                   (not (before 'end 'end))))
