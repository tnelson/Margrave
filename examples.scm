...
(load-policy (build-path my-directory "tests" "extconference.p"))
(load-policy (build-path my-directory "tests" "conference1.p"))
(load-policy (build-path my-directory "tests" "conference2.p"))
(load-policy (build-path my-directory "tests" "phone1.p"))
(load-policy (build-path my-directory "tests" "fwex1.p"))
(load-policy (build-path my-directory "tests" "fwex1a.p"))
(load-policy (build-path my-directory "tests" "fwex2.p"))
(load-policy (build-path my-directory "tests" "fwex3.p"))
(load-policy (build-path my-directory "tests" "happyrouterless.p"))
(load-policy (build-path my-directory "tests" "happyroutermore.p"))
(load-policy (build-path my-directory "tests" "iout.p"))
